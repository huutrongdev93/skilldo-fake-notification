...
class FakeNotificationAdminAjax {
    static function customerRandom($ci, $model): bool
    {
        $result['status'] = 'error';
        ...
        if(Request::post()) {
            ...
            $fullName = [
                ...
                'Nguyễn Huỳnh Mỹ Diễm',
                'Nguyễn Hoàng Phúc',
                'Nguyễn Thị Diệu Linh',
                'Võ Huỳnh Lanh',
                'Nguyễn Mậu Bửu Duy',
                'Nguyễn Vũ Khoa Nguyên',
                'Nguyễn Thị Trúc Mai',
                'Đào Ngọc Phú',
                'Nguyễn Hoàng Uyên  Giao',
                'Nguyễn Thanh Bình',
                'Lê Thị Minh  Phượng',
                'Trần Thị Tâm',
                'Hồ Hạnh Tiên',
                ...
                'Lê Thị  Liểu',
                'Phạm Thị Ngọc Huyền',
                'Nguyễn Thị Trang Anh',
                'Trần Hoàng Anh Thư',
                'Đào Thị  Dung',
                'Lê Công  Hậu',
                'Trương Thị Phượng Hằng',
                'Huỳnh Thị Yến Oanh',
                'Dương Kiều Huyền  Trân',
                ...
                'Hoàng Ngọc Tai',
                'Tấn Phát',
                'Phạm Nguyễn Phi Hồng Yến',
                'Đỗ Đức Nghiệp',
                'Phan Thị Thanh Tâm',
                'Nguyễn Việt Vĩ Tú',
                'Ngô Quốc Cường',
                'Nguyễn Minh Trí',
                'Lê Thị Như Hảo',
                'Trần Ngọc Minh',
                ...
                'Nguyễn Thùy Trang',
                'Trương Thị Thùy Tuyên',
                'Trần Thị Kim Trúc',
                'Phùng Đình Thạnh',
                'Nguyễn Trần Tưởng Huy',
                'Đỗ Trọng Bằng',
                'Nguyễn Văn Tâm',
                'Đỗ Duy Hùng',
                'Hoàng Nhật Nam',
    ...
    static function productSearch($ci, $model): bool
    {
        ...
        if(Request::post()) {
            ...
            foreach ($products as $product) {
                ...
                $result['data'] .= Plugin::partial(FAKE_NOTIFICATION_NAME, 'admin/product-item', ['item' => $product], true);
            }
    ...
    static function productRandom($ci, $model): bool
    {
        $result['status'] = 'error';
    ...
    static function productLoad($ci, $model): bool
    {
        ...
        if(Request::post()) {
            ...
            $result['products'] = Product::gets($args);
            $result['status']   = 'success';
            $result['message']  = 'Load dữ liệu thành công';
        }
    ...
    static function save($ci, $model): bool
    {
        ...
        if(Request::post()) {
            ...
            if(!have_posts($customers)) {
                $result['message']  = 'Bạn chưa tạo danh sách khách hàng ảo';
                echo json_encode($result);
                return false;
            }
            ...
            foreach ($customers as $key => $item) {
                ...
                if(empty($item['address'])) {
                    $result['message']  = 'Không được để trống giá trị địa chỉ khách hàng';
                    echo json_encode($result);
                    return false;
                }
                ...
                if(empty($item['content'])) {
                    $result['message']  = 'Không được để trống giá trị hành động khách hàng';
                    echo json_encode($result);
                    return false;
                }
            ...
            $dataType = Request::post('fakeDataType');

            if($dataType == 'handmade') {

                $handmadeItems = Request::post('handmade');

                if(!have_posts($handmadeItems)) {
                    $result['message']  = 'Bạn chưa tạo danh sách dữ liệu ảo';
                    echo json_encode($result);
                    return false;
                }
                ...
                foreach ($handmadeItems as $key => $item) {
                    ...
                    if(!isset($item['title'])) {
                        $result['message']  = 'Không được để trống tiêu đề dữ liệu mẫu';
                        echo json_encode($result);
                        return false;
                    }
                    ...
                    if(!isset($item['image'])) {
                        $result['message']  = 'Không được để trống hình ảnh dữ liệu mẫu';
                        echo json_encode($result);
                        return false;
                    }
                    ...
                    if(!isset($item['url'])) {
                        $result['message']  = 'Không được để trống liên kết dữ liệu mẫu';
                        echo json_encode($result);
                        return false;
                    }
...
class FakeNotificationAjax {
    static function load($ci, $model): bool
    {
        $result['status'] = 'error';
